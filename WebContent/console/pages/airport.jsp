...
<br>
destination airport: <input type="search" name="toAirportName" id="toAirportName" list="airports" placeholder="Pick the destination airport..">
...
Buy A Hub <input type="search" name="airportToBuy" id="airportToBuy" list="airports" placeholder="Pick a hub to buy">
<datalist id="airports">
<option value="Akron-Canton Regional">
<option value="Albany International">
<option value="Albuquerque International Sunport">
